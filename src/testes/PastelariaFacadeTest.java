...
public class PastelariaFacadeTest {
	...
	public void diminuirQtdeDeUmProdutoTest() {
		...
		Assert.assertTrue("N�o esta diminuindo o produto do estoque",
				p2.getQtdeProduto() == 2);
	}
	...
	public void adicionarClienteComTelefonesIguaisTest() {
		...
		Cliente cliente = new Cliente("Renata", "32266279",
				"R. Cora��o de Jesus", "Par�quia Santo Antonio");
		fachada.adicionarClienteNoSistema(cliente);
		Cliente cliente2 = new Cliente("Jo�o", "32266279",
				"R. Cora��o de Jesus", "Par�quia Santo Antonio");
	...
	public void removerUmClienteDoSistemaTest() {
		...
		Assert.assertTrue("O cliente n�o foi removido",
	...
	public void quantidadeDeComandasAbertasTest() {
		...
		// Rodrigo, voc� tinha reclamado porque tinha este m�todo
		// Modifiquei o m�todo na fachada, onde ele chama o getComanda().size
		// Este m�todo foi criado porque nos testes s� podemos inicializar a
		// fachada, certo?
		// A n�o ser que n�o precise deste teste, para saber como a lista de
		// comandas est� se comportando...
	}
	...
	public void removerComandaTest() {
		...
		Assert.assertTrue("N�o foi removida comanda", qtde == 4);
	...
	public void adicionarMesmoItemEmVariasComandas() {
		...
		Assert.assertTrue("O item n�o est� sendo adicionado as comanda  ",
	...
	public void fecharDoCaixaDoDiaTest() {
		...
		// pesquisar como arredondar, ou s� aparecer duas casas decimais
